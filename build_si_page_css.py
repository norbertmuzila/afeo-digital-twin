...
.si-tab-btn {
  background: none; border: none; padding: 12px 24px; font-weight: 600; cursor: pointer; color: var(--text-muted);
  border-bottom: 2px solid transparent; transition: all 0.2s; font-size: 15px;
}
.si-tab-btn.active {
...
.si-map-panel.mode-3d #siMapWrapper {
...
.si-card {
  ...
  box-shadow: 0 2px 8px rgba(0,0,0,0.02); display: flex; flex-direction: column; gap: 8px;
}
...
print("style.css updated for Site Intel Page")
